<%-- 
    Document   : depart
    Created on : Mar 18, 2020, 11:31:57 PM
    Author     : PC
--%>
...
<html>
    ...
    <body>
        <h2 style="padding: 10px; font-weight: bold"><s:message code="admin.general.depart.title"/></h2>
            ...
            <div class="card">
              <div class="card-header pb-0">
                  ...
                  <div class="form-group col-8">
                      <form action="admin/general/searchdepart.htm" >
                    <div class="row">
              ...
              <div class="card-body table-responsive p-0" style="height: 300px;">
                  ...
                  <thead>
                    <tr style="text-align: center">
                      <th><s:message code="admin.general.depart.table.depart"/></th>
                      <th><s:message code="admin.general.depart.table.achievements"/></th>
                      <th><s:message code="admin.general.depart.table.discipline"/></th>
                      <th><s:message code="admin.general.depart.table.total"/></th>
                    </tr>
                  </thead>
                  <tbody id="myTable">
                    <c:forEach var="u" items="${listdepart}">
                      <tr style="text-align: center">
                      <td><span class="badge badge-success">${u[0]}</span></td>
                      <td>${u[1]}</td>
                      <td>${u[2]}</td>
                      <th style=" font-weight: bold;">${u[3]}</th>
                    </tr>
                    </c:forEach>
                  </tbody>
                </table>
