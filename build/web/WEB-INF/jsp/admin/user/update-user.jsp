<%-- 
    ...
    Created on : Feb 22, 2020, 3:06:53 AM
    Author     : PC
--%>
...
<html>
    ...
    <body>
        <h2 style="padding: 10px; font-weight: bold"><s:message code="admin.user.updUser.title"/></h2>
        <p class="text-success" >${message}</p>
        <form:form action="admin/user/update.htm"  modelAttribute="user" method="post">
		...
		<div class="form-group">
			...
			<label>Vai trò:</label>
                ...
                <div class="custom-control custom-radio custom-control-inline">
                    ...
                    <br> <br>
                    <center><button type="submit" class="btn btn-primary"><s:message code="admin.user.updUser.btnUpdate"/></button></center>
	</form:form>
    </body>
</html>
